 ...
 */
@Component
public class Auth2ApiProxy {

    private static final Logger logger = LoggerFactory.getLogger(Auth2ApiProxy.class);

    @Autowired
    private RibbonManager ribbonManager;

    public List<AuthSimpleUser> getSimpleUserList(List<Integer> userIdList) {
