...
import com.ucpaas.restsdk.SSLHttpClient;
...
public abstract class AbsRestClient {
	public boolean isTest() {
        return Boolean.parseBoolean(PropertiesUtil.getContextProperty("is_test"));
    }
	public String server() {
        return PropertiesUtil.getContextProperty("rest_server");
    }
	public String sslIP() {
        return PropertiesUtil.getContextProperty("http_ssl_ip");
    }
	public int sslPort() {
        return Integer.parseInt(PropertiesUtil.getContextProperty("http_ssl_port"));
    }
	public String version() {
        return PropertiesUtil.getContextProperty("version");
    }
	 ...
	 * callback
	 */
	public abstract String callback(String accountSid, String authToken,String appId,String fromClient,String to,String fromSerNum,String toSerNum,String orderId,String ringtoneID);
	/**
	 * 
	 * @param accountSid
	 * @param authToken
	 ...
	 * @return
	 */
	public abstract String voiceNotify(String accountSid, String authToken, String appId,String content,String to, String type,String toSerNum,String playTimes);
	
	
	public abstract String createConference(String accountSid,String authToken, String appId,
			String maxMember, Integer duration, Integer playTone);
	
	public abstract String removeConference(String accountSid,String authToken, String appId,String confId,String callId);
	
	public abstract String dismissConference(String accountSid,String authToken, String appId,String confId);
	
	public abstract String inviteConference(String accountSid,String authToken, String appId,String confId,List<Member> list);
	
	
	public abstract String muteConference(String accountSid,String authToken, String appId,String confId,String callId);
	
	public abstract String unMuteConference(String accountSid,String authToken, String appId,String confId,String callId);
	
	public abstract String deafConference(String accountSid,String authToken, String appId,String confId,String callId);
	
	public abstract String unDeafConference(String accountSid,String authToken, String appId,String confId,String callId);
	
	public abstract String queryConference(String accountSid,String authToken, String appId,String confId);
	
	public abstract String recordConference(String accountSid,String authToken, String appId,String confId);
	
	public abstract String stopRecordConference(String accountSid,String authToken, String appId,String confId);
